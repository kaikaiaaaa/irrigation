...
一个面向农民和灌溉管理人员的智能灌溉决策助手网页应用。基于天气数据、土壤湿度数据和农业专家知识，为每个设备/地块提供科学的灌溉建议，帮助用户做出更准确的浇水决策。

## Core Value

用户打开应用就能看到每个设备的当前状态以及基于天气、土壤湿度和专家知识的综合灌溉建议，无需专业知识即可做出正确的浇水决策。
...
| 综合决策模型 | 天气 + 土壤湿度 + 专家知识，更准确的灌溉建议 | — Pending |
